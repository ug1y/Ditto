...
一个混合型区块图模拟框架，其中区块图是指基于有向无环图的区块链。该框架可以交互式地展示区块图的生成、共识协议的执行，以及拜占庭攻击效果。该项目被命名为`Ditto`，取自宝可梦动漫里的百变怪，寓意该框架可以模拟各种图区块链系统。

## 目标

受开源项目 [PHANTOM](https://github.com/AvivYaish/PHANTOM.git) 和 [py-swirld](https://github.com/Lapin0t/py-swirld.git) 的启发，本项目扩展了区块图模拟框架，
包括如下功能：
